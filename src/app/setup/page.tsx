...
export default function SetupPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Use the updateTripDates utility to handle date changes
    const updatedTripState = updateTripDates(tripState, startDate, endDate);
    
    // Update the base currency
    updatedTripState.baseCurrency = baseCurrency;
